...
parser.add_argument('data_directory', help='data directory path')
parser.add_argument('--save_dir', help='Path where the checkpoint should be saved')
...
parser.add_argument('--gpu', help='Boolean value for using GPU for training', action='store_true')
